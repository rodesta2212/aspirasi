		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="row">
						<div class="pd-20 col-6" style="padding-left:35px;">
							<h4 class="text-blue h4"><i class="dw dw-print"></i> Print Aspirasi</h4>
							<!-- <p class="mb-0">you can find more options <a class="text-primary" href="https://datatables.net/" target="_blank">Click Here</a></p> -->
						</div>
						<div class="pd-20 col-6" style="padding-right:35px;">
							<!-- <a href="ujian-create"> -->
								<button type="submit" class="btn btn-success float-right" onclick="printDiv('printableArea')">Print</button>
							<!-- </a> -->
						</div>
					</div>
				</div>
				<div class="card-box mb-30" id="printableArea">
