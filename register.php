					...
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<?php
								if($_POST){
									// post mahasiswa
									$Register->id_mahasiswa = $_POST["id_mahasiswa"];
									$Register->nama = $_POST["nama"];
									$Register->jurusan = $_POST["jurusan"];
							...
							<form method="POST" class="tab-wizard2 wizard-circle wizard">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										<input type="hidden" name="id_mahasiswa" value="<?php echo $Register->getNewId(); ?>">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										<div class="form-group row align-items-center">
											<label class="col-sm-4 col-form-label">Jurusan<span style="color:red;">*</span></label>
											<div class="col-sm-8">
												<select class="custom-select" name="jurusan">
													...
													<option value="S1 - Manajemen Ritel">S1 - Manajemen Ritel</option>
												</select>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">NIM<span style="color:red;">*</span></label>
											<div class="col-sm-8">
												<input type="number" min="0" class="form-control" name="nim" required>
											</div>
										</div>
									</div>
								</section>
